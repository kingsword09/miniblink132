...
DemoService::DemoService(mojo::PendingReceiver<viz::mojom::FrameSinkManager> receiver, mojo::PendingRemote<viz::mojom::FrameSinkManagerClient> client)
{
...
scoped_refptr<base::SingleThreadTaskRunner> DemoService::GetCompositorThreadRunner()
{
    return runner_->task_runner();
}
