...
public:
    DemoHost(gfx::AcceleratedWidget widget, const gfx::Size& size, mojo::PendingReceiver<viz::mojom::FrameSinkManagerClient> client_receiver,
...
private:
    ...
    base::WeakPtrFactory<DemoHost> weak_ptr_factory_ { this };
};
