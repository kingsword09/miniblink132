...
PROTOBUF_CONSTEXPR SysStatsConfig::SysStatsConfig(
  ...
  , /*decltype(_impl_.thermal_period_ms_)*/0u
  , /*decltype(_impl_.cpuidle_period_ms_)*/0u
  , /*decltype(_impl_.gpufreq_period_ms_)*/0u} {}
...
class SysStatsConfig::_Internal {
 public:
  ...
  static void set_has_thermal_period_ms(HasBits* has_bits) {
    (*has_bits)[0] |= 256u;
  }
  static void set_has_cpuidle_period_ms(HasBits* has_bits) {
    (*has_bits)[0] |= 512u;
  }
  static void set_has_gpufreq_period_ms(HasBits* has_bits) {
    (*has_bits)[0] |= 1024u;
  }
};
...
SysStatsConfig::SysStatsConfig(const SysStatsConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.thermal_period_ms_){}
    , decltype(_impl_.cpuidle_period_ms_){}
    , decltype(_impl_.gpufreq_period_ms_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&_impl_.meminfo_period_ms_, &from._impl_.meminfo_period_ms_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.gpufreq_period_ms_) -
    reinterpret_cast<char*>(&_impl_.meminfo_period_ms_)) + sizeof(_impl_.gpufreq_period_ms_));
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.SysStatsConfig)
  ...
  if (cached_has_bits & 0x00000700u) {
    ::memset(&_impl_.thermal_period_ms_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&_impl_.gpufreq_period_ms_) -
        reinterpret_cast<char*>(&_impl_.thermal_period_ms_)) + sizeof(_impl_.gpufreq_period_ms_));
  }
    ...
    switch (tag >> 3) {
      ...
      case 12:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 96)) {
          _Internal::set_has_thermal_period_ms(&has_bits);
          _impl_.thermal_period_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 13:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 104)) {
          _Internal::set_has_cpuidle_period_ms(&has_bits);
          _impl_.cpuidle_period_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 14:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 112)) {
          _Internal::set_has_gpufreq_period_ms(&has_bits);
          _impl_.gpufreq_period_ms_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SysStatsConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000100u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(12, this->_internal_thermal_period_ms(), target);
  }

  // optional uint32 cpuidle_period_ms = 13;
  if (cached_has_bits & 0x00000200u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(13, this->_internal_cpuidle_period_ms(), target);
  }

  // optional uint32 gpufreq_period_ms = 14;
  if (cached_has_bits & 0x00000400u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(14, this->_internal_gpufreq_period_ms(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.SysStatsConfig)
  ...
  if (cached_has_bits & 0x00000700u) {
    // optional uint32 thermal_period_ms = 12;
    if (cached_has_bits & 0x00000100u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_thermal_period_ms());
    }

    // optional uint32 cpuidle_period_ms = 13;
    if (cached_has_bits & 0x00000200u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_cpuidle_period_ms());
    }

    // optional uint32 gpufreq_period_ms = 14;
    if (cached_has_bits & 0x00000400u) {
      total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_gpufreq_period_ms());
    }
