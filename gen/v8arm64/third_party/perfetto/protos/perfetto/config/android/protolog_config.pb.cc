...
PROTOBUF_CONSTEXPR ProtoLogConfig::ProtoLogConfig(
  ...
  , /*decltype(_impl_.default_log_from_level_)*/0} {}
...
class ProtoLogConfig::_Internal {
 public:
  ...
  static void set_has_default_log_from_level(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
};
...
ProtoLogConfig::ProtoLogConfig(const ProtoLogConfig& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.default_log_from_level_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&_impl_.tracing_mode_, &from._impl_.tracing_mode_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.default_log_from_level_) -
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          if (PROTOBUF_PREDICT_TRUE(::perfetto::protos::ProtoLogLevel_IsValid(val))) {
            _internal_set_default_log_from_level(static_cast<::perfetto::protos::ProtoLogLevel>(val));
          } else {
...
uint8_t* ProtoLogConfig::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      3, this->_internal_default_log_from_level(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.ProtoLogConfig)
  ...
  if (cached_has_bits & 0x00000003u) {
    ...
    if (cached_has_bits & 0x00000002u) {
      total_size += 1 +
        ::_pbi::WireFormatLite::EnumSize(this->_internal_default_log_from_level());
    }
