...
PROTOBUF_CONSTEXPR FollowerEvent::FollowerEvent(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.name_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
struct FollowerEventDefaultTypeInternal {
  PROTOBUF_CONSTEXPR FollowerEventDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 FollowerEventDefaultTypeInternal _FollowerEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class FollowerEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<FollowerEvent>()._impl_._has_bits_);
  static const ::perfetto::protos::PerfEvents_Tracepoint& tracepoint(const FollowerEvent* msg);
  static const ::perfetto::protos::PerfEvents_RawEvent& raw_event(const FollowerEvent* msg);
  static void set_has_name(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
};
...
const ::perfetto::protos::PerfEvents_Tracepoint&
FollowerEvent::_Internal::tracepoint(const FollowerEvent* msg) {
  return *msg->_impl_.event_.tracepoint_;
}
const ::perfetto::protos::PerfEvents_RawEvent&
FollowerEvent::_Internal::raw_event(const FollowerEvent* msg) {
  return *msg->_impl_.event_.raw_event_;
}
void FollowerEvent::set_allocated_tracepoint(::perfetto::protos::PerfEvents_Tracepoint* tracepoint) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_event();
  if (tracepoint) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
void FollowerEvent::set_allocated_raw_event(::perfetto::protos::PerfEvents_RawEvent* raw_event) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_event();
  if (raw_event) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
FollowerEvent::FollowerEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:perfetto.protos.FollowerEvent)
}
FollowerEvent::FollowerEvent(const FollowerEvent& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  FollowerEvent* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.name_){}
...
inline void FollowerEvent::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
inline void FollowerEvent::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.name_.Destroy();
  if (has_event()) {
    clear_event();
...
void FollowerEvent::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}
...
const char* FollowerEvent::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
...
uint8_t* FollowerEvent::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  switch (event_case()) {
    ...
    case kTracepoint: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(2, _Internal::tracepoint(this),
          _Internal::tracepoint(this).GetCachedSize(), target, stream);
      break;
    }
    case kRawEvent: {
      target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(3, _Internal::raw_event(this),
          _Internal::raw_event(this).GetCachedSize(), target, stream);
      break;
    }
    default: ;
...
void FollowerEvent::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const FollowerEvent*>(
      &from));
}

void FollowerEvent::MergeFrom(const FollowerEvent& from) {
...
bool FollowerEvent::IsInitialized() const {
  return true;
}

void FollowerEvent::InternalSwap(FollowerEvent* other) {
  using std::swap;
  auto* lhs_arena = GetArenaForAllocation();
  auto* rhs_arena = other->GetArenaForAllocation();
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
std::string FollowerEvent::GetTypeName() const {
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::FollowerEvent*
Arena::CreateMaybeMessage< ::perfetto::protos::FollowerEvent >(Arena* arena) {
  return Arena::CreateMessageInternal< ::perfetto::protos::FollowerEvent >(arena);
}
