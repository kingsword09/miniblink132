...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> BuiltinClock_strings[10] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry BuiltinClock_entries[] = {
  ...
  { {BuiltinClock_names + 191, 17}, 9 },
  { {BuiltinClock_names + 208, 21}, 0 },
};

static const int BuiltinClock_entries_by_number[] = {
  9, // 0 -> BUILTIN_CLOCK_UNKNOWN
...
bool BuiltinClock_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      BuiltinClock_entries, 10, name, &int_value);
  if (success) {
