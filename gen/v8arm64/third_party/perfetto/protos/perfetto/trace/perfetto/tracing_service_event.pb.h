...
class TracingServiceEvent_DataSources_DataSource final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(TracingServiceEvent_DataSources_DataSource* other) {
  ...
  TracingServiceEvent_DataSources_DataSource* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class TracingServiceEvent_DataSources final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(TracingServiceEvent_DataSources* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  TracingServiceEvent_DataSources* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
