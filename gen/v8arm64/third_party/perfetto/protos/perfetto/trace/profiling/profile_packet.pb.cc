...
PROTOBUF_CONSTEXPR PerfSample::PerfSample(
    ...
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.follower_counts_)*/{}
...
PerfSample::PerfSample(const PerfSample& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.follower_counts_){from._impl_.follower_counts_}
    , decltype(_impl_.producer_event_){nullptr}
...
inline void PerfSample::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.follower_counts_){arena}
    , decltype(_impl_.producer_event_){nullptr}
    , decltype(_impl_.cpu_){0u}
    , decltype(_impl_.pid_){0u}
    , decltype(_impl_.callstack_iid_){uint64_t{0u}}
...
inline void PerfSample::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.follower_counts_.~RepeatedField();
    ...
    switch (tag >> 3) {
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          ...
          do {
            ptr += 1;
            _internal_add_follower_counts(::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr));
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
          } while (::PROTOBUF_NAMESPACE_ID::internal::ExpectTag<56>(ptr));
        } else if (static_cast<uint8_t>(tag) == 58) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedUInt64Parser(_internal_mutable_follower_counts(), ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* PerfSample::_InternalSerialize(
  ...
  // repeated uint64 follower_counts = 7;
  for (int i = 0, n = this->_internal_follower_counts_size(); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(7, this->_internal_follower_counts(i), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.PerfSample)
  ...
  {
    size_t data_size = ::_pbi::WireFormatLite::
      UInt64Size(this->_impl_.follower_counts_);
    total_size += 1 *
                  ::_pbi::FromIntSize(this->_internal_follower_counts_size());
    total_size += data_size;
  }
...
void PerfSample::MergeFrom(const PerfSample& from) {
  ...
  _this->_impl_.follower_counts_.MergeFrom(from._impl_.follower_counts_);
  cached_has_bits = from._impl_._has_bits_[0];
  if (cached_has_bits & 0x000000ffu) {
    if (cached_has_bits & 0x00000001u) {
