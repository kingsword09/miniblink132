...
PROTOBUF_CONSTEXPR SchedWakeupTaskAttrFtraceEvent::SchedWakeupTaskAttrFtraceEvent(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.cpu_affinity_)*/uint64_t{0u}
  , /*decltype(_impl_.task_util_)*/uint64_t{0u}
  , /*decltype(_impl_.uclamp_min_)*/uint64_t{0u}
  , /*decltype(_impl_.vruntime_)*/uint64_t{0u}
  , /*decltype(_impl_.pid_)*/0} {}
struct SchedWakeupTaskAttrFtraceEventDefaultTypeInternal {
  PROTOBUF_CONSTEXPR SchedWakeupTaskAttrFtraceEventDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SchedWakeupTaskAttrFtraceEventDefaultTypeInternal _SchedWakeupTaskAttrFtraceEvent_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class SchedWakeupTaskAttrFtraceEvent::_Internal {
 public:
  using HasBits = decltype(std::declval<SchedWakeupTaskAttrFtraceEvent>()._impl_._has_bits_);
  static void set_has_pid(HasBits* has_bits) {
    (*has_bits)[0] |= 16u;
  }
  static void set_has_cpu_affinity(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static void set_has_task_util(HasBits* has_bits) {
    (*has_bits)[0] |= 2u;
  }
  static void set_has_uclamp_min(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
  static void set_has_vruntime(HasBits* has_bits) {
    (*has_bits)[0] |= 8u;
  }
};

SchedWakeupTaskAttrFtraceEvent::SchedWakeupTaskAttrFtraceEvent(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:perfetto.protos.SchedWakeupTaskAttrFtraceEvent)
}
SchedWakeupTaskAttrFtraceEvent::SchedWakeupTaskAttrFtraceEvent(const SchedWakeupTaskAttrFtraceEvent& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  SchedWakeupTaskAttrFtraceEvent* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_._has_bits_){from._impl_._has_bits_}
    , /*decltype(_impl_._cached_size_)*/{}
    , decltype(_impl_.cpu_affinity_){}
    , decltype(_impl_.task_util_){}
    , decltype(_impl_.uclamp_min_){}
    , decltype(_impl_.vruntime_){}
    , decltype(_impl_.pid_){}};

  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  ::memcpy(&_impl_.cpu_affinity_, &from._impl_.cpu_affinity_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.pid_) -
    reinterpret_cast<char*>(&_impl_.cpu_affinity_)) + sizeof(_impl_.pid_));
  // @@protoc_insertion_point(copy_constructor:perfetto.protos.SchedWakeupTaskAttrFtraceEvent)
}

inline void SchedWakeupTaskAttrFtraceEvent::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
inline void SchedWakeupTaskAttrFtraceEvent::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void SchedWakeupTaskAttrFtraceEvent::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void SchedWakeupTaskAttrFtraceEvent::Clear() {
...
const char* SchedWakeupTaskAttrFtraceEvent::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          _Internal::set_has_cpu_affinity(&has_bits);
          _impl_.cpu_affinity_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          _Internal::set_has_task_util(&has_bits);
          _impl_.task_util_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          _Internal::set_has_uclamp_min(&has_bits);
          _impl_.uclamp_min_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          _Internal::set_has_vruntime(&has_bits);
          _impl_.vruntime_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SchedWakeupTaskAttrFtraceEvent::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  if (cached_has_bits & 0x00000001u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(2, this->_internal_cpu_affinity(), target);
  }

  // optional uint64 task_util = 3;
  if (cached_has_bits & 0x00000002u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(3, this->_internal_task_util(), target);
  }

  // optional uint64 uclamp_min = 4;
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(4, this->_internal_uclamp_min(), target);
  }

  // optional uint64 vruntime = 5;
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(5, this->_internal_vruntime(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.SchedWakeupTaskAttrFtraceEvent)
  ...
  if (cached_has_bits & 0x0000001fu) {
    // optional uint64 cpu_affinity = 2;
    if (cached_has_bits & 0x00000001u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_cpu_affinity());
    }

    // optional uint64 task_util = 3;
    if (cached_has_bits & 0x00000002u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_task_util());
    }

    // optional uint64 uclamp_min = 4;
    if (cached_has_bits & 0x00000004u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_uclamp_min());
    }

    // optional uint64 vruntime = 5;
    if (cached_has_bits & 0x00000008u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_vruntime());
    }
...
void SchedWakeupTaskAttrFtraceEvent::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::_pbi::DownCast<const SchedWakeupTaskAttrFtraceEvent*>(
      &from));
}

void SchedWakeupTaskAttrFtraceEvent::MergeFrom(const SchedWakeupTaskAttrFtraceEvent& from) {
  SchedWakeupTaskAttrFtraceEvent* const _this = this;
...
bool SchedWakeupTaskAttrFtraceEvent::IsInitialized() const {
  return true;
}

void SchedWakeupTaskAttrFtraceEvent::InternalSwap(SchedWakeupTaskAttrFtraceEvent* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_._has_bits_[0], other->_impl_._has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
...
std::string SchedWakeupTaskAttrFtraceEvent::GetTypeName() const {
...
template<> PROTOBUF_NOINLINE ::perfetto::protos::SchedWakeupTaskAttrFtraceEvent*
Arena::CreateMaybeMessage< ::perfetto::protos::SchedWakeupTaskAttrFtraceEvent >(Arena* arena) {
  return Arena::CreateMessageInternal< ::perfetto::protos::SchedWakeupTaskAttrFtraceEvent >(arena);
}
