...
PROTOBUF_CONSTEXPR SchedSwitchWithCtrsFtraceEvent::SchedSwitchWithCtrsFtraceEvent(
  ...
  , /*decltype(_impl_.cctr_)*/uint64_t{0u}
  , /*decltype(_impl_.ctr0_)*/uint64_t{0u}
  , /*decltype(_impl_.ctr1_)*/uint64_t{0u}
  , /*decltype(_impl_.ctr2_)*/uint64_t{0u}
  , /*decltype(_impl_.ctr3_)*/uint64_t{0u}
  , /*decltype(_impl_.lctr0_)*/0u
  , /*decltype(_impl_.lctr1_)*/0u
  , /*decltype(_impl_.ctr4_)*/uint64_t{0u}
  , /*decltype(_impl_.ctr5_)*/uint64_t{0u}
  ...
  , /*decltype(_impl_.amu0_)*/uint64_t{0u}
  , /*decltype(_impl_.amu1_)*/uint64_t{0u}
  , /*decltype(_impl_.amu2_)*/uint64_t{0u}} {}
...
class SchedSwitchWithCtrsFtraceEvent::_Internal {
 public:
  ...
  static void set_has_amu0(HasBits* has_bits) {
    (*has_bits)[0] |= 1048576u;
  }
  static void set_has_amu1(HasBits* has_bits) {
    (*has_bits)[0] |= 2097152u;
  }
  static void set_has_amu2(HasBits* has_bits) {
    (*has_bits)[0] |= 4194304u;
  }
};
...
SchedSwitchWithCtrsFtraceEvent::SchedSwitchWithCtrsFtraceEvent(const SchedSwitchWithCtrsFtraceEvent& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.amu0_){}
    , decltype(_impl_.amu1_){}
    , decltype(_impl_.amu2_){}};
  ...
  ::memcpy(&_impl_.old_pid_, &from._impl_.old_pid_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.amu2_) -
    reinterpret_cast<char*>(&_impl_.old_pid_)) + sizeof(_impl_.amu2_));
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          _impl_.cctr_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          ...
          _impl_.ctr0_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          _impl_.ctr1_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          _impl_.ctr2_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 56)) {
          ...
          _impl_.ctr3_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 80)) {
          ...
          _impl_.ctr4_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 11:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 88)) {
          ...
          _impl_.ctr5_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 21:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 168)) {
          _Internal::set_has_amu0(&has_bits);
          _impl_.amu0_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 22:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 176)) {
          _Internal::set_has_amu1(&has_bits);
          _impl_.amu1_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 23:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 184)) {
          _Internal::set_has_amu2(&has_bits);
          _impl_.amu2_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SchedSwitchWithCtrsFtraceEvent::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(3, this->_internal_cctr(), target);
  }

  // optional uint64 ctr0 = 4;
  if (cached_has_bits & 0x00000020u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(4, this->_internal_ctr0(), target);
  }

  // optional uint64 ctr1 = 5;
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(5, this->_internal_ctr1(), target);
  }

  // optional uint64 ctr2 = 6;
  if (cached_has_bits & 0x00000080u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(6, this->_internal_ctr2(), target);
  }

  // optional uint64 ctr3 = 7;
  if (cached_has_bits & 0x00000100u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(7, this->_internal_ctr3(), target);
  }
  ...
  if (cached_has_bits & 0x00000800u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(10, this->_internal_ctr4(), target);
  }

  // optional uint64 ctr5 = 11;
  if (cached_has_bits & 0x00001000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(11, this->_internal_ctr5(), target);
  }
  ...
  if (cached_has_bits & 0x00040000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(18, this->_internal_next_pid(), target);
  }

  // optional string next_comm = 19;
  if (cached_has_bits & 0x00000002u) {
    target = stream->WriteStringMaybeAliased(
        19, this->_internal_next_comm(), target);
  }

  // optional int64 prev_state = 20;
  if (cached_has_bits & 0x00080000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt64ToArray(20, this->_internal_prev_state(), target);
  }

  // optional uint64 amu0 = 21;
  if (cached_has_bits & 0x00100000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(21, this->_internal_amu0(), target);
  }

  // optional uint64 amu1 = 22;
  if (cached_has_bits & 0x00200000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(22, this->_internal_amu1(), target);
  }

  // optional uint64 amu2 = 23;
  if (cached_has_bits & 0x00400000u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(23, this->_internal_amu2(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.SchedSwitchWithCtrsFtraceEvent)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    // optional uint64 cctr = 3;
    if (cached_has_bits & 0x00000010u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_cctr());
    }

    // optional uint64 ctr0 = 4;
    if (cached_has_bits & 0x00000020u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_ctr0());
    }

    // optional uint64 ctr1 = 5;
    if (cached_has_bits & 0x00000040u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_ctr1());
    }

    // optional uint64 ctr2 = 6;
    if (cached_has_bits & 0x00000080u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_ctr2());
    }
  ...
  if (cached_has_bits & 0x0000ff00u) {
    // optional uint64 ctr3 = 7;
    if (cached_has_bits & 0x00000100u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_ctr3());
    }
    ...
    // optional uint64 ctr4 = 10;
    if (cached_has_bits & 0x00000800u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_ctr4());
    }

    // optional uint64 ctr5 = 11;
    if (cached_has_bits & 0x00001000u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_ctr5());
    }
