...
PROTOBUF_CONSTEXPR FtraceEventBundle::FtraceEventBundle(
  ...
  , /*decltype(_impl_.previous_bundle_end_timestamp_)*/uint64_t{0u}
...
class FtraceEventBundle::_Internal {
 public:
  ...
  static void set_has_previous_bundle_end_timestamp(HasBits* has_bits) {
    (*has_bits)[0] |= 64u;
  }
};
...
FtraceEventBundle::FtraceEventBundle(const FtraceEventBundle& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.previous_bundle_end_timestamp_){}
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 80)) {
          _Internal::set_has_previous_bundle_end_timestamp(&has_bits);
          _impl_.previous_bundle_end_timestamp_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* FtraceEventBundle::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000040u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(10, this->_internal_previous_bundle_end_timestamp(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:perfetto.protos.FtraceEventBundle)
  ...
  if (cached_has_bits & 0x000000ffu) {
    ...
    // optional uint64 previous_bundle_end_timestamp = 10;
    if (cached_has_bits & 0x00000040u) {
      total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_previous_bundle_end_timestamp());
    }
