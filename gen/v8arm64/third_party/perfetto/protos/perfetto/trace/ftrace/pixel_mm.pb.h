...
class PixelMmKswapdWakeFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PixelMmKswapdWakeFtraceEvent* other) {
  ...
  PixelMmKswapdWakeFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class PixelMmKswapdDoneFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(PixelMmKswapdDoneFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  PixelMmKswapdDoneFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
