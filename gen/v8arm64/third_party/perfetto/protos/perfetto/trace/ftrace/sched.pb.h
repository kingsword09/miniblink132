...
class SchedWakeupTaskAttrFtraceEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SchedWakeupTaskAttrFtraceEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  SchedWakeupTaskAttrFtraceEvent* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
