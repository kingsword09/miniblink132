...
const std::string& ChromeLatencyInfo_InputType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ChromeLatencyInfo_InputType_entries,
          ChromeLatencyInfo_InputType_entries_by_number,
          7, ChromeLatencyInfo_InputType_strings);
  (void) dummy;
  int idx = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumName(
      ChromeLatencyInfo_InputType_entries,
      ChromeLatencyInfo_InputType_entries_by_number,
      7, value);
  return idx == -1 ? ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyString() :
                     ChromeLatencyInfo_InputType_strings[idx].get();
}
...
ChromeLatencyInfo::ChromeLatencyInfo(const ChromeLatencyInfo& from)
  ...
  ::memcpy(&_impl_.trace_id_, &from._impl_.trace_id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.touch_id_) -
    ...
    switch (tag >> 3) {
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 64)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::perfetto::protos::ChromeLatencyInfo_InputType_IsValid(val))) {
            _internal_set_input_type(static_cast<::perfetto::protos::ChromeLatencyInfo_InputType>(val));
          } else {
