...
// Keep Node's public bridge macros aligned with the platform-specific Node
// build.  On macOS libnode is built without OpenSSL/inspector, and redefining
// these here changes internal class layouts in any translation unit that also
// includes Node internals.
#if defined(OS_MAC)
