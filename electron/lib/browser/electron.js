...
Object.assign(electron, {
  ...
  contentTracing: require('./api/content-tracing'),
  crashReporter: require('./api/crash-reporter'),
  ...
  systemPreferences: require('./api/system-preferences'),
  TouchBar: require('./api/touch-bar'),
